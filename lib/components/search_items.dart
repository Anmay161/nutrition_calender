...
//   const SearchItems({super.key, required this.date, required this.time, this.onUpdate});
...
//       setState(() {
//         displayedItems = dataset.where((item) => item.name.toLowerCase().contains(query)).toList();
//       });
//     });
//   }
...
//     setState(() {
//       dataset = data
//           .map((e) => Item(e['Food name in Bengali']?.toString() ?? 'Unknown', false))
//           .toList();
...
//           final isSelected = selectedList.any((selected) => selected.name == item.name);
...
//                     onPressed: () {
//                       setState(() {
//                         selectedList.removeWhere((selected) => selected.name == item.name);
//                       });
...
//                     onPressed: () {
//                       setState(() {
//                         selectedList.add(Item(item.name, true));
//                       });
//                       widget.onUpdate?.call();
//                     },
//                   ),
